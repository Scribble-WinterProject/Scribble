...
import { getCurrentUser, getSession } from '../../appwrite/api'
import { useEmailVerificationMutation } from '../../reactQuery/queries'
...
function ProfilePage() {
    ...
    useEffect(()=> {
      ...
      const handleForgetPaasword = async (e) => {
        e.preventDefault();   
        const forget = await emailVerification(user.email);
        console.log(forget);
      };
    ...
    return (
      <div className="profile-page-wrapper">
        ...
        <div className="profile-card">
          ...
          <button className="profile-btn" onClick={handleForgetPaasword}>
            Forgot Password
          </button>
        </div>
      </div>
